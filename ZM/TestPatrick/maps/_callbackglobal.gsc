...
{
	if( (self HasPerk("specialty_detectexplosive")) && (sMeansOfDeath == "MOD_GRENADE_SPLASH" || sMeansOfDeath == "MOD_GRENADE" || sMeansOfDeath == "MOD_EXPLOSIVE" || sMeansOfDeath == "MOD_PROJECTILE" || sMeansOfDeath == "MOD_PROJECTILE_SPLASH" || sMeansOfDeath == "MOD_BURNED" || sMeansOfDeath == "MOD_FALLING"))
	{
...
{
	self endon( "disconnect" ); 
	old_maxhp = self.maxhealth;
	old_hp = self.health;
	self RevivePlayer();
	self.maxhealth = old_maxhp;
	self.health = old_hp;
}
